...
/**
 * RunwayHub - Login für Piloten und VA-Inhaber
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-container { max-width: 400px; width: 100%; background: rgba(255,255,255,0.1); padding: 40px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); }
        h1 { text-align: center; margin-bottom: 30px; font-size: 2em; }
        .form-group { margin-bottom: 20px; }
        label { display: block; margin-bottom: 5px; font-weight: bold; }
        input[type="text"], input[type="password"] { width: 100%; padding: 12px; border: none; border-radius: 5px; background: rgba(255,255,255,0.9); font-size: 1em; }
        input[type="text"]:focus, input[type="password"]:focus { outline: 2px solid rgba(255,255,255,0.5); }
...
<body>
    <div class="login-container">
        <h1>🛫 RunwayHub Login</h1>
        
        <form method="POST" action="/api/login-pilot.php">
            <div class="form-group">
                <label for="callsign">🪪 Callsign:</label>
                <input type="text" id="callsign" name="callsign" placeholder="SW001" required autofocus>
            </div>
