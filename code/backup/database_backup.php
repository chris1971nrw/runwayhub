 ...
 * 
 * Creates SQLite database backups with timestamp.
 * 
...
$config = [
    ...
    'log_file' => getenv('BACKUP_LOG_FILE') ?: 'backups/backup.log',
];
...
copy($config['database'], $backup_path);
...
echo "Backups in directory: " . count(glob("{$config['backup_dir']}/runwayhub_backup_*.gz")) . PHP_EOL;
